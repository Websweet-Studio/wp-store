(() => {
      ...
      (function (window2, factory) {
        ...
        proto.getPositionValue = function (position) {
          if (this.options.percentPosition) {
            return (
              Math.round((position / this.size.innerWidth) * 1e4) * 0.01 + "%"
            );
          } else {
      ...
      (function (window2, factory) {
        ...
        function factory(
          ...
          proto.watchCSS = function () {
            ...
            var afterContent = getComputedStyle2(
              this.element,
              ":after",
            ).content;
  ...
  var require_add_remove_cell = __commonJS({
    "node_modules/flickity/js/add-remove-cell.js"(exports, module) {
      (function (window2, factory) {
        if (typeof define == "function" && define.amd) {
          define(["./flickity", "fizzy-ui-utils/utils"], function (
            Flickity2,
            utils,
          ) {
